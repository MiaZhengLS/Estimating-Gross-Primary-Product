...
class NEmbedding(tf.keras.Model):
    ...
    #     config.update(
    #         {
    #         "num_features": keras.saving.serialize_keras_object(self.num_features),
    #         "features": keras.saving.serialize_keras_object(self.features),
    #         "emb_type": keras.saving.serialize_keras_object(self.emb_type),
    #         "emb_dim": keras.saving.serialize_keras_object(self.emb_dim),
    #         "linear_w": keras.saving.serialize_keras_object(self.linear_w),
    #         "linear_b": keras.saving.serialize_keras_object(self.linear_b),
    #         }
    #     )
    #     return config
...
#         return {**base_config, **config}
    ...
    #     sublayer = keras.saving.deserialize_keras_object(num_features)
